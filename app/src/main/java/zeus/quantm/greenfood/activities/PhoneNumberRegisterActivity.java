...
public class PhoneNumberRegisterActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Assign views
      //  mPhoneNumberViews = (ViewGroup) findViewById(R.id.input_phone);
     ...
     //   mDetailText = (TextView) findViewById(R.id.detail);
        ...
        mVerificationField = (EditText) findViewById(R.id.input_code);

        mStartButton = (Button) findViewById(R.id.btn_send);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // [START_EXCLUDE]
                            Toast.makeText(PhoneNumberRegisterActivity.this,"verify success",Toast.LENGTH_SHORT).show();
                            // [END_EXCLUDE]
                        } else {
                         ...
                         //   updateUI(STATE_SIGNIN_FAILED);
                            Toast.makeText(PhoneNumberRegisterActivity.this,"verify fail",Toast.LENGTH_SHORT).show();
                            // [END_EXCLUDE]
                        }
                    }
                });
